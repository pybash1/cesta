...
export default function Login() {
  ...
  const verifyCode = () => {
    ...
    Auth.forgotPasswordSubmit(emailch, code, passwordch)
      .then((data) => {
        console.log(data);
      ...
      .catch((e) => {
        if (
          ...
          toast.error(
            "Password must be at least 8 characters long, contain one number, special character, and capital letter!"
          );
        } else {
          console.log(e);
          return;
  ...
  const handleSignIn = () => {
    ...
    signIn(email, password)
      ...
      .catch((e) => {
        if (
          e.toString() == "UserNotConfirmedException: User is not confirmed."
        ) {
